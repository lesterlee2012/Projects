...
if(!preg_match('/^[\w\x80-\xff]{6,15}$/', $userid)){
    exit('userid is not allowed <a href="javascript:history.back(-1);">back</a>');
}
...
$sql = "INSERT INTO users(userid,password,firstname,lastname,email,age,hphold)VALUES('$userid','$password','$firstname','$lastname','$email','$age','100')";
