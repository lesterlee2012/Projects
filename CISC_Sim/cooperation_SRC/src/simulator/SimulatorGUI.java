...
public class SimulatorGUI extends javax.swing.JFrame {
    ...
    private void IPLCMDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IPLCMDActionPerformed
        ...
        /*sm.setMemoryValue(2033, 0);
        sm.setMemoryValue(2034, 0);
        sm.setMemoryValue(2035, 0);
        sm.setMemoryValue(2036, 0);
        sm.setMemoryValue(2037, 0);
        sm.setMemoryValue(2038, 0);
        sm.setMemoryValue(2039, 0);
        sm.setMemoryValue(2040, 0);
        sm.setMemoryValue(2041, 0);
        sm.setMemoryValue(2042, 0);
        sm.setMemoryValue(2043, 0);
        sm.setMemoryValue(2044, 0);
        sm.setMemoryValue(2045, 0);
        sm.setMemoryValue(2046, 0);
        sm.setMemoryValue(2047, 0);
        sm.setMemoryValue(2048, 0);*/
